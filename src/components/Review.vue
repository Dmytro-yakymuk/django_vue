    ...
    <div class="row">
        <div class="single-form-left">
            <div class="contact-single">
                ...
                <span class="sub-tittle editContent">0</span>Оставить отзыв</h3>
                <form action="#" method="get" class="mt-4" id="formReview">
                    <div class="form-group editContent">
                        <label for="contactcomment" class="editContent">Ваш комментарий*</label>
                        <textarea v-model="text" class="form-control border" rows="5" id="contactcomment" required=""></textarea>
                    </div>
                    <div class="d-sm-flex">
                        <div class="col-sm-6 form-group p-0 editContent">
                            <label for="contactusername" class="editContent">Имя*</label>
                            <input v-model="name" type="text" class="form-control border" id="contactusername" required="">
                        </div>
                        <div class="col-sm-6 form-group ml-sm-3 editContent">
                            <label for="contactemail" class="editContent">Email*</label>
                            <input v-model="email" type="email" class="form-control border" id="contactemail" required="">
                        </div>
                    </div>
                    <button @click="sendReview()" type="button" class="mt-3 btn btn-success btn-block py-3">Отправить</button>
                </form>
            </div>
        </div>
        <div class="media py-5 review" v-for="review in reviews" :key="review.id">
            ...
            <div class="media-body mt-4">
                ...
                <a href="#formReview" @click="addParent(review.id)">Reply</a>
